...
<?php $__env->startSection('content'); ?>
    ...
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="<?php echo e(asset('assets/code/highcharts.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/code/modules/data.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/code/modules/drilldown.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/code/modules/exporting.js')); ?>"></script>
    <!-- ================== END PAGE LEVEL JS ================== -->
...
<?php echo $__env->make('main.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\IUlat\resources\views/middleman/dashboard.blade.php ENDPATH**/ ?>