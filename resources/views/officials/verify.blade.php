...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Report Verification</h1>
    <!-- end page-header -->
        ...
        <div>
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading" style="background-color:maroon">
                    ...
                    <h4 class="panel-title">Report Verification</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin alert -->
                <div class="alert alert-yellow fade show">
                    ...
                    Report Verification list of reports that are for verification. 
                </div>
                <!-- end alert -->
                <!-- begin panel-body -->
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td> <b>{{$value->ReportTypeDescription}} </b>: {{$value->ReportSubTypeDescription}}
                                  <br>  <small>{{$value->ReportDescription}} </small>
                                </td>
                            
                                <td>{{$value->OnHold}} Days </td>
